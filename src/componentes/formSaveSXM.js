...
function FormSXM (props){
  ...
  return (
    ...
    <Modal okButtonProps={{ style: { display: 'none' } }} title="Agregar submenú a menú" visible={isModalVisible} onOk={handleOk} onCancel={handleCancel}>
    <Form
      name="login"
      labelCol={{
        span: 6,
